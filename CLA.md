...
You represent that each of Your Contributions is Your original work (see Section 7 for submissions on behalf of others). You represent that, to Your knowledge, no other person or entity claims, or has the right to claim, any right in any invention or patent or copyright related to Your Contributions.
...
2. The CLA Assistant bot will record your signature and add a status check to your pull requests.

Alternatively, the project maintainer may recheck your signature status by commenting `recheck` on your pull request.
